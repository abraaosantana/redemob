...
create table if not exists rocket.aux_endereco
(id int8 not null,
...
create table if not exists rocket.seg_grupo
(id int8 not null,
 active boolean not null,
 date_created timestamp,
 last_updated timestamp,
...
create table if not exists rocket.seg_usuario
(id int8 not null,
 active boolean not null,
 cpf varchar(255),
...
create table if not exists rocket.seg_usuario_grupo
(grupo_id int8 not null,
 usuario_id int8 not null,
 primary key (grupo_id, usuario_id)
);

create table if not exists rocket.seg_usuario_profile
(id int8 not null,
 active boolean not null,
 celular varchar(255),
 date_created timestamp,
...
create table if not exists rocket.solicitacao
(id int8 not null,
 active boolean not null,
 date_created timestamp,
...
create sequence if not exists rocket.aux_endereco_seq start 1 increment 1;

create sequence if not exists rocket.seg_grupo_seq start 3 increment 1;

create sequence if not exists rocket.seg_usuario_profile_seq start 1 increment 1;

create sequence if not exists rocket.seg_usuario_seq start 3 increment 1;

create sequence if not exists rocket.solicitacao_seq start 1 increment 1;
